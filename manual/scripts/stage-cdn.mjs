...
//
// Usage: node scripts/stage-cdn.mjs [--src ../manual-build/cdn] [--dest public/cdn] [--domain surgext ...]
...
function parseArgs(argv) {
  const out = { src: resolve(root, '../manual-build/cdn'), dest: resolve(root, 'public/cdn'), domains: [] };
