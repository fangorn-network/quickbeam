import { LocaleProfile } from "./types";

export const enJackson: LocaleProfile = {
  id: 'en-jackson',
  lang: 'en-US',
  community: {
    ...
    regionAbbr: 'MS',
    tagline:
      'Local places, events & everyday life in Jackson. Search by meaning, vibe, location, anything.',
    blurb: 'A living guide to Jackson, MS and its environs, made searchable.',
  },
  strings: {
    search: {
      placeholder: 'Find your Jackson vibe… e.g., kid friendly restaurants',
      subtext:
        'Search by feel, not just name. Try "late night music” or “quiet patio for coffee”',
